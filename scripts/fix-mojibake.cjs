...
const TECH_PAGES = [
  ...
  { id: '3352403f-bc5c-816a-ba33-ef8d3f6b9ebf', slug: 'ros2-publisher-subscriber' },
  { id: '3512403f-bc5c-8113-8950-f88b87f14818', slug: 'turtlebot3-ros2-overview' },
  { id: '3512403f-bc5c-811a-8937-e5e332d4bccd', slug: 'turtlebot3-ros2-host-pc-setup' },
]

const INVESTMENT_PAGES = [
  { id: '3532403f-bc5c-81f0-954a-d3b8653d503e', slug: 'dca-drawdown-python-nisa' },
  { id: '3532403f-bc5c-814f-844f-d199a1c69eab', slug: 'nisa-monthly-amount-from-budget' },
  { id: '3532403f-bc5c-81fc-8fd3-ce697ebfac02', slug: 'emergency-fund-before-nisa' },
  { id: '3532403f-bc5c-818f-a7b5-e85ee134a8df', slug: 'all-country-vs-sp500-nisa' },
  { id: '3532403f-bc5c-81d6-a5e5-e32dee831aff', slug: 'household-budget-50k-to-investment' },
]
...
const TECH_SECTION_BLOCKS = [
  {
    ...
    type: 'heading_2',
    heading_2: {
      rich_text: [{ type: 'text', text: { content: '検証環境と失敗しやすい点' } }],
    },
  },
  {
    object: 'block',
  ...
  },
  {
    ...
    bulleted_list_item: {
      rich_text: [{ type: 'text', text: { content: 'Ubuntu 22.04 LTS（実機）' } }],
    },
  },
  {
    object: 'block',
...
const INVESTMENT_SECTION_BLOCKS = [
  {
    ...
    type: 'heading_2',
    heading_2: {
      rich_text: [{ type: 'text', text: { content: '投資記事の前提と注意点' } }],
    },
  },
  {
    object: 'block',
